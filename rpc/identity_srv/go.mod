module github.com/masonsxu/cloudwego-microservice-demo/rpc/identity-srv
...
replace github.com/masonsxu/cloudwego-microservice-demo/rpc/policy-srv => ../policy_srv
