...
func createOAuth2ClientHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.CreateOAuth2ClientRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).CreateOAuth2Client(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *CreateOAuth2ClientArgs:
		success, err := handler.(identity_srv.IdentityService).CreateOAuth2Client(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*CreateOAuth2ClientResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newCreateOAuth2ClientArgs() interface{} {
	return &CreateOAuth2ClientArgs{}
}

func newCreateOAuth2ClientResult() interface{} {
	return &CreateOAuth2ClientResult{}
}

type CreateOAuth2ClientArgs struct {
	Req *identity_srv.CreateOAuth2ClientRequest
}

func (p *CreateOAuth2ClientArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *CreateOAuth2ClientArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.CreateOAuth2ClientRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var CreateOAuth2ClientArgs_Req_DEFAULT *identity_srv.CreateOAuth2ClientRequest

func (p *CreateOAuth2ClientArgs) GetReq() *identity_srv.CreateOAuth2ClientRequest {
	if !p.IsSetReq() {
		return CreateOAuth2ClientArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *CreateOAuth2ClientArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *CreateOAuth2ClientArgs) GetFirstArgument() interface{} {
	return p.Req
}

type CreateOAuth2ClientResult struct {
	Success *identity_srv.CreateOAuth2ClientResponse
}

var CreateOAuth2ClientResult_Success_DEFAULT *identity_srv.CreateOAuth2ClientResponse

func (p *CreateOAuth2ClientResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *CreateOAuth2ClientResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.CreateOAuth2ClientResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *CreateOAuth2ClientResult) GetSuccess() *identity_srv.CreateOAuth2ClientResponse {
	if !p.IsSetSuccess() {
		return CreateOAuth2ClientResult_Success_DEFAULT
	}
	return p.Success
}

func (p *CreateOAuth2ClientResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.CreateOAuth2ClientResponse)
}

func (p *CreateOAuth2ClientResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CreateOAuth2ClientResult) GetResult() interface{} {
	return p.Success
}
...
func getOAuth2ClientHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.GetOAuth2ClientRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).GetOAuth2Client(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetOAuth2ClientArgs:
		success, err := handler.(identity_srv.IdentityService).GetOAuth2Client(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetOAuth2ClientResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetOAuth2ClientArgs() interface{} {
	return &GetOAuth2ClientArgs{}
}

func newGetOAuth2ClientResult() interface{} {
	return &GetOAuth2ClientResult{}
}

type GetOAuth2ClientArgs struct {
	Req *identity_srv.GetOAuth2ClientRequest
}

func (p *GetOAuth2ClientArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetOAuth2ClientArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2ClientRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetOAuth2ClientArgs_Req_DEFAULT *identity_srv.GetOAuth2ClientRequest

func (p *GetOAuth2ClientArgs) GetReq() *identity_srv.GetOAuth2ClientRequest {
	if !p.IsSetReq() {
		return GetOAuth2ClientArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetOAuth2ClientArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetOAuth2ClientArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetOAuth2ClientResult struct {
	Success *identity_srv.OAuth2Client
}

var GetOAuth2ClientResult_Success_DEFAULT *identity_srv.OAuth2Client

func (p *GetOAuth2ClientResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetOAuth2ClientResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2Client)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetOAuth2ClientResult) GetSuccess() *identity_srv.OAuth2Client {
	if !p.IsSetSuccess() {
		return GetOAuth2ClientResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetOAuth2ClientResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.OAuth2Client)
}

func (p *GetOAuth2ClientResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetOAuth2ClientResult) GetResult() interface{} {
	return p.Success
}
...
func updateOAuth2ClientHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.UpdateOAuth2ClientRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).UpdateOAuth2Client(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UpdateOAuth2ClientArgs:
		success, err := handler.(identity_srv.IdentityService).UpdateOAuth2Client(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*UpdateOAuth2ClientResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newUpdateOAuth2ClientArgs() interface{} {
	return &UpdateOAuth2ClientArgs{}
}

func newUpdateOAuth2ClientResult() interface{} {
	return &UpdateOAuth2ClientResult{}
}

type UpdateOAuth2ClientArgs struct {
	Req *identity_srv.UpdateOAuth2ClientRequest
}

func (p *UpdateOAuth2ClientArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *UpdateOAuth2ClientArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.UpdateOAuth2ClientRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var UpdateOAuth2ClientArgs_Req_DEFAULT *identity_srv.UpdateOAuth2ClientRequest

func (p *UpdateOAuth2ClientArgs) GetReq() *identity_srv.UpdateOAuth2ClientRequest {
	if !p.IsSetReq() {
		return UpdateOAuth2ClientArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *UpdateOAuth2ClientArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *UpdateOAuth2ClientArgs) GetFirstArgument() interface{} {
	return p.Req
}

type UpdateOAuth2ClientResult struct {
	Success *identity_srv.OAuth2Client
}

var UpdateOAuth2ClientResult_Success_DEFAULT *identity_srv.OAuth2Client

func (p *UpdateOAuth2ClientResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *UpdateOAuth2ClientResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2Client)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *UpdateOAuth2ClientResult) GetSuccess() *identity_srv.OAuth2Client {
	if !p.IsSetSuccess() {
		return UpdateOAuth2ClientResult_Success_DEFAULT
	}
	return p.Success
}

func (p *UpdateOAuth2ClientResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.OAuth2Client)
}

func (p *UpdateOAuth2ClientResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UpdateOAuth2ClientResult) GetResult() interface{} {
	return p.Success
}
...
func deleteOAuth2ClientHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.DeleteOAuth2ClientRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).DeleteOAuth2Client(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeleteOAuth2ClientArgs:
		success, err := handler.(identity_srv.IdentityService).DeleteOAuth2Client(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*DeleteOAuth2ClientResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newDeleteOAuth2ClientArgs() interface{} {
	return &DeleteOAuth2ClientArgs{}
}

func newDeleteOAuth2ClientResult() interface{} {
	return &DeleteOAuth2ClientResult{}
}

type DeleteOAuth2ClientArgs struct {
	Req *identity_srv.DeleteOAuth2ClientRequest
}

func (p *DeleteOAuth2ClientArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *DeleteOAuth2ClientArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.DeleteOAuth2ClientRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var DeleteOAuth2ClientArgs_Req_DEFAULT *identity_srv.DeleteOAuth2ClientRequest

func (p *DeleteOAuth2ClientArgs) GetReq() *identity_srv.DeleteOAuth2ClientRequest {
	if !p.IsSetReq() {
		return DeleteOAuth2ClientArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *DeleteOAuth2ClientArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *DeleteOAuth2ClientArgs) GetFirstArgument() interface{} {
	return p.Req
}

type DeleteOAuth2ClientResult struct {
	Success *identity_srv.DeleteOAuth2ClientResponse
}

var DeleteOAuth2ClientResult_Success_DEFAULT *identity_srv.DeleteOAuth2ClientResponse

func (p *DeleteOAuth2ClientResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *DeleteOAuth2ClientResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.DeleteOAuth2ClientResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *DeleteOAuth2ClientResult) GetSuccess() *identity_srv.DeleteOAuth2ClientResponse {
	if !p.IsSetSuccess() {
		return DeleteOAuth2ClientResult_Success_DEFAULT
	}
	return p.Success
}

func (p *DeleteOAuth2ClientResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.DeleteOAuth2ClientResponse)
}

func (p *DeleteOAuth2ClientResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *DeleteOAuth2ClientResult) GetResult() interface{} {
	return p.Success
}
...
func listOAuth2ClientsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.ListOAuth2ClientsRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).ListOAuth2Clients(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ListOAuth2ClientsArgs:
		success, err := handler.(identity_srv.IdentityService).ListOAuth2Clients(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*ListOAuth2ClientsResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newListOAuth2ClientsArgs() interface{} {
	return &ListOAuth2ClientsArgs{}
}

func newListOAuth2ClientsResult() interface{} {
	return &ListOAuth2ClientsResult{}
}

type ListOAuth2ClientsArgs struct {
	Req *identity_srv.ListOAuth2ClientsRequest
}

func (p *ListOAuth2ClientsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *ListOAuth2ClientsArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.ListOAuth2ClientsRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var ListOAuth2ClientsArgs_Req_DEFAULT *identity_srv.ListOAuth2ClientsRequest

func (p *ListOAuth2ClientsArgs) GetReq() *identity_srv.ListOAuth2ClientsRequest {
	if !p.IsSetReq() {
		return ListOAuth2ClientsArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *ListOAuth2ClientsArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ListOAuth2ClientsArgs) GetFirstArgument() interface{} {
	return p.Req
}

type ListOAuth2ClientsResult struct {
	Success *identity_srv.ListOAuth2ClientsResponse
}

var ListOAuth2ClientsResult_Success_DEFAULT *identity_srv.ListOAuth2ClientsResponse

func (p *ListOAuth2ClientsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *ListOAuth2ClientsResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.ListOAuth2ClientsResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *ListOAuth2ClientsResult) GetSuccess() *identity_srv.ListOAuth2ClientsResponse {
	if !p.IsSetSuccess() {
		return ListOAuth2ClientsResult_Success_DEFAULT
	}
	return p.Success
}

func (p *ListOAuth2ClientsResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.ListOAuth2ClientsResponse)
}

func (p *ListOAuth2ClientsResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ListOAuth2ClientsResult) GetResult() interface{} {
	return p.Success
}
...
func rotateOAuth2ClientSecretHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.RotateOAuth2ClientSecretRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).RotateOAuth2ClientSecret(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *RotateOAuth2ClientSecretArgs:
		success, err := handler.(identity_srv.IdentityService).RotateOAuth2ClientSecret(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*RotateOAuth2ClientSecretResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newRotateOAuth2ClientSecretArgs() interface{} {
	return &RotateOAuth2ClientSecretArgs{}
}

func newRotateOAuth2ClientSecretResult() interface{} {
	return &RotateOAuth2ClientSecretResult{}
}

type RotateOAuth2ClientSecretArgs struct {
	Req *identity_srv.RotateOAuth2ClientSecretRequest
}

func (p *RotateOAuth2ClientSecretArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *RotateOAuth2ClientSecretArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.RotateOAuth2ClientSecretRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var RotateOAuth2ClientSecretArgs_Req_DEFAULT *identity_srv.RotateOAuth2ClientSecretRequest

func (p *RotateOAuth2ClientSecretArgs) GetReq() *identity_srv.RotateOAuth2ClientSecretRequest {
	if !p.IsSetReq() {
		return RotateOAuth2ClientSecretArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *RotateOAuth2ClientSecretArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *RotateOAuth2ClientSecretArgs) GetFirstArgument() interface{} {
	return p.Req
}

type RotateOAuth2ClientSecretResult struct {
	Success *identity_srv.RotateOAuth2ClientSecretResponse
}

var RotateOAuth2ClientSecretResult_Success_DEFAULT *identity_srv.RotateOAuth2ClientSecretResponse

func (p *RotateOAuth2ClientSecretResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *RotateOAuth2ClientSecretResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.RotateOAuth2ClientSecretResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *RotateOAuth2ClientSecretResult) GetSuccess() *identity_srv.RotateOAuth2ClientSecretResponse {
	if !p.IsSetSuccess() {
		return RotateOAuth2ClientSecretResult_Success_DEFAULT
	}
	return p.Success
}

func (p *RotateOAuth2ClientSecretResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.RotateOAuth2ClientSecretResponse)
}

func (p *RotateOAuth2ClientSecretResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RotateOAuth2ClientSecretResult) GetResult() interface{} {
	return p.Success
}
...
func getOAuth2ClientForAuthHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.GetOAuth2ClientForAuthRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).GetOAuth2ClientForAuth(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetOAuth2ClientForAuthArgs:
		success, err := handler.(identity_srv.IdentityService).GetOAuth2ClientForAuth(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetOAuth2ClientForAuthResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetOAuth2ClientForAuthArgs() interface{} {
	return &GetOAuth2ClientForAuthArgs{}
}

func newGetOAuth2ClientForAuthResult() interface{} {
	return &GetOAuth2ClientForAuthResult{}
}

type GetOAuth2ClientForAuthArgs struct {
	Req *identity_srv.GetOAuth2ClientForAuthRequest
}

func (p *GetOAuth2ClientForAuthArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetOAuth2ClientForAuthArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2ClientForAuthRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetOAuth2ClientForAuthArgs_Req_DEFAULT *identity_srv.GetOAuth2ClientForAuthRequest

func (p *GetOAuth2ClientForAuthArgs) GetReq() *identity_srv.GetOAuth2ClientForAuthRequest {
	if !p.IsSetReq() {
		return GetOAuth2ClientForAuthArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetOAuth2ClientForAuthArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetOAuth2ClientForAuthArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetOAuth2ClientForAuthResult struct {
	Success *identity_srv.GetOAuth2ClientForAuthResponse
}

var GetOAuth2ClientForAuthResult_Success_DEFAULT *identity_srv.GetOAuth2ClientForAuthResponse

func (p *GetOAuth2ClientForAuthResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetOAuth2ClientForAuthResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2ClientForAuthResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetOAuth2ClientForAuthResult) GetSuccess() *identity_srv.GetOAuth2ClientForAuthResponse {
	if !p.IsSetSuccess() {
		return GetOAuth2ClientForAuthResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetOAuth2ClientForAuthResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.GetOAuth2ClientForAuthResponse)
}

func (p *GetOAuth2ClientForAuthResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetOAuth2ClientForAuthResult) GetResult() interface{} {
	return p.Success
}
...
func listOAuth2ScopesHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.ListOAuth2ScopesRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).ListOAuth2Scopes(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ListOAuth2ScopesArgs:
		success, err := handler.(identity_srv.IdentityService).ListOAuth2Scopes(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*ListOAuth2ScopesResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newListOAuth2ScopesArgs() interface{} {
	return &ListOAuth2ScopesArgs{}
}

func newListOAuth2ScopesResult() interface{} {
	return &ListOAuth2ScopesResult{}
}

type ListOAuth2ScopesArgs struct {
	Req *identity_srv.ListOAuth2ScopesRequest
}

func (p *ListOAuth2ScopesArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *ListOAuth2ScopesArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.ListOAuth2ScopesRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var ListOAuth2ScopesArgs_Req_DEFAULT *identity_srv.ListOAuth2ScopesRequest

func (p *ListOAuth2ScopesArgs) GetReq() *identity_srv.ListOAuth2ScopesRequest {
	if !p.IsSetReq() {
		return ListOAuth2ScopesArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *ListOAuth2ScopesArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ListOAuth2ScopesArgs) GetFirstArgument() interface{} {
	return p.Req
}

type ListOAuth2ScopesResult struct {
	Success *identity_srv.ListOAuth2ScopesResponse
}

var ListOAuth2ScopesResult_Success_DEFAULT *identity_srv.ListOAuth2ScopesResponse

func (p *ListOAuth2ScopesResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *ListOAuth2ScopesResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.ListOAuth2ScopesResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *ListOAuth2ScopesResult) GetSuccess() *identity_srv.ListOAuth2ScopesResponse {
	if !p.IsSetSuccess() {
		return ListOAuth2ScopesResult_Success_DEFAULT
	}
	return p.Success
}

func (p *ListOAuth2ScopesResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.ListOAuth2ScopesResponse)
}

func (p *ListOAuth2ScopesResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ListOAuth2ScopesResult) GetResult() interface{} {
	return p.Success
}
...
func saveOAuth2ConsentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.SaveOAuth2ConsentRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).SaveOAuth2Consent(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *SaveOAuth2ConsentArgs:
		success, err := handler.(identity_srv.IdentityService).SaveOAuth2Consent(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*SaveOAuth2ConsentResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newSaveOAuth2ConsentArgs() interface{} {
	return &SaveOAuth2ConsentArgs{}
}

func newSaveOAuth2ConsentResult() interface{} {
	return &SaveOAuth2ConsentResult{}
}

type SaveOAuth2ConsentArgs struct {
	Req *identity_srv.SaveOAuth2ConsentRequest
}

func (p *SaveOAuth2ConsentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *SaveOAuth2ConsentArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.SaveOAuth2ConsentRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var SaveOAuth2ConsentArgs_Req_DEFAULT *identity_srv.SaveOAuth2ConsentRequest

func (p *SaveOAuth2ConsentArgs) GetReq() *identity_srv.SaveOAuth2ConsentRequest {
	if !p.IsSetReq() {
		return SaveOAuth2ConsentArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *SaveOAuth2ConsentArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *SaveOAuth2ConsentArgs) GetFirstArgument() interface{} {
	return p.Req
}

type SaveOAuth2ConsentResult struct {
	Success *identity_srv.SaveOAuth2ConsentResponse
}

var SaveOAuth2ConsentResult_Success_DEFAULT *identity_srv.SaveOAuth2ConsentResponse

func (p *SaveOAuth2ConsentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *SaveOAuth2ConsentResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.SaveOAuth2ConsentResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *SaveOAuth2ConsentResult) GetSuccess() *identity_srv.SaveOAuth2ConsentResponse {
	if !p.IsSetSuccess() {
		return SaveOAuth2ConsentResult_Success_DEFAULT
	}
	return p.Success
}

func (p *SaveOAuth2ConsentResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.SaveOAuth2ConsentResponse)
}

func (p *SaveOAuth2ConsentResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SaveOAuth2ConsentResult) GetResult() interface{} {
	return p.Success
}
...
func getOAuth2ConsentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.GetOAuth2ConsentRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).GetOAuth2Consent(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetOAuth2ConsentArgs:
		success, err := handler.(identity_srv.IdentityService).GetOAuth2Consent(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetOAuth2ConsentResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetOAuth2ConsentArgs() interface{} {
	return &GetOAuth2ConsentArgs{}
}

func newGetOAuth2ConsentResult() interface{} {
	return &GetOAuth2ConsentResult{}
}

type GetOAuth2ConsentArgs struct {
	Req *identity_srv.GetOAuth2ConsentRequest
}

func (p *GetOAuth2ConsentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetOAuth2ConsentArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2ConsentRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetOAuth2ConsentArgs_Req_DEFAULT *identity_srv.GetOAuth2ConsentRequest

func (p *GetOAuth2ConsentArgs) GetReq() *identity_srv.GetOAuth2ConsentRequest {
	if !p.IsSetReq() {
		return GetOAuth2ConsentArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetOAuth2ConsentArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetOAuth2ConsentArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetOAuth2ConsentResult struct {
	Success *identity_srv.GetOAuth2ConsentResponse
}

var GetOAuth2ConsentResult_Success_DEFAULT *identity_srv.GetOAuth2ConsentResponse

func (p *GetOAuth2ConsentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetOAuth2ConsentResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2ConsentResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetOAuth2ConsentResult) GetSuccess() *identity_srv.GetOAuth2ConsentResponse {
	if !p.IsSetSuccess() {
		return GetOAuth2ConsentResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetOAuth2ConsentResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.GetOAuth2ConsentResponse)
}

func (p *GetOAuth2ConsentResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetOAuth2ConsentResult) GetResult() interface{} {
	return p.Success
}
...
func listOAuth2ConsentsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.ListOAuth2ConsentsRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).ListOAuth2Consents(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ListOAuth2ConsentsArgs:
		success, err := handler.(identity_srv.IdentityService).ListOAuth2Consents(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*ListOAuth2ConsentsResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newListOAuth2ConsentsArgs() interface{} {
	return &ListOAuth2ConsentsArgs{}
}

func newListOAuth2ConsentsResult() interface{} {
	return &ListOAuth2ConsentsResult{}
}

type ListOAuth2ConsentsArgs struct {
	Req *identity_srv.ListOAuth2ConsentsRequest
}

func (p *ListOAuth2ConsentsArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *ListOAuth2ConsentsArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.ListOAuth2ConsentsRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var ListOAuth2ConsentsArgs_Req_DEFAULT *identity_srv.ListOAuth2ConsentsRequest

func (p *ListOAuth2ConsentsArgs) GetReq() *identity_srv.ListOAuth2ConsentsRequest {
	if !p.IsSetReq() {
		return ListOAuth2ConsentsArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *ListOAuth2ConsentsArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ListOAuth2ConsentsArgs) GetFirstArgument() interface{} {
	return p.Req
}

type ListOAuth2ConsentsResult struct {
	Success *identity_srv.ListOAuth2ConsentsResponse
}

var ListOAuth2ConsentsResult_Success_DEFAULT *identity_srv.ListOAuth2ConsentsResponse

func (p *ListOAuth2ConsentsResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *ListOAuth2ConsentsResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.ListOAuth2ConsentsResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *ListOAuth2ConsentsResult) GetSuccess() *identity_srv.ListOAuth2ConsentsResponse {
	if !p.IsSetSuccess() {
		return ListOAuth2ConsentsResult_Success_DEFAULT
	}
	return p.Success
}

func (p *ListOAuth2ConsentsResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.ListOAuth2ConsentsResponse)
}

func (p *ListOAuth2ConsentsResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ListOAuth2ConsentsResult) GetResult() interface{} {
	return p.Success
}
...
func revokeOAuth2ConsentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.RevokeOAuth2ConsentRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).RevokeOAuth2Consent(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *RevokeOAuth2ConsentArgs:
		success, err := handler.(identity_srv.IdentityService).RevokeOAuth2Consent(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*RevokeOAuth2ConsentResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newRevokeOAuth2ConsentArgs() interface{} {
	return &RevokeOAuth2ConsentArgs{}
}

func newRevokeOAuth2ConsentResult() interface{} {
	return &RevokeOAuth2ConsentResult{}
}

type RevokeOAuth2ConsentArgs struct {
	Req *identity_srv.RevokeOAuth2ConsentRequest
}

func (p *RevokeOAuth2ConsentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *RevokeOAuth2ConsentArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.RevokeOAuth2ConsentRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var RevokeOAuth2ConsentArgs_Req_DEFAULT *identity_srv.RevokeOAuth2ConsentRequest

func (p *RevokeOAuth2ConsentArgs) GetReq() *identity_srv.RevokeOAuth2ConsentRequest {
	if !p.IsSetReq() {
		return RevokeOAuth2ConsentArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *RevokeOAuth2ConsentArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *RevokeOAuth2ConsentArgs) GetFirstArgument() interface{} {
	return p.Req
}

type RevokeOAuth2ConsentResult struct {
	Success *identity_srv.RevokeOAuth2ConsentResponse
}

var RevokeOAuth2ConsentResult_Success_DEFAULT *identity_srv.RevokeOAuth2ConsentResponse

func (p *RevokeOAuth2ConsentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *RevokeOAuth2ConsentResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.RevokeOAuth2ConsentResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *RevokeOAuth2ConsentResult) GetSuccess() *identity_srv.RevokeOAuth2ConsentResponse {
	if !p.IsSetSuccess() {
		return RevokeOAuth2ConsentResult_Success_DEFAULT
	}
	return p.Success
}

func (p *RevokeOAuth2ConsentResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.RevokeOAuth2ConsentResponse)
}

func (p *RevokeOAuth2ConsentResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RevokeOAuth2ConsentResult) GetResult() interface{} {
	return p.Success
}
...
func createOAuth2AuthorizeCodeSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.OAuth2TokenSession)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).CreateOAuth2AuthorizeCodeSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *CreateOAuth2AuthorizeCodeSessionArgs:
		success, err := handler.(identity_srv.IdentityService).CreateOAuth2AuthorizeCodeSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*CreateOAuth2AuthorizeCodeSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newCreateOAuth2AuthorizeCodeSessionArgs() interface{} {
	return &CreateOAuth2AuthorizeCodeSessionArgs{}
}

func newCreateOAuth2AuthorizeCodeSessionResult() interface{} {
	return &CreateOAuth2AuthorizeCodeSessionResult{}
}

type CreateOAuth2AuthorizeCodeSessionArgs struct {
	Req *identity_srv.OAuth2TokenSession
}

func (p *CreateOAuth2AuthorizeCodeSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *CreateOAuth2AuthorizeCodeSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2TokenSession)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var CreateOAuth2AuthorizeCodeSessionArgs_Req_DEFAULT *identity_srv.OAuth2TokenSession

func (p *CreateOAuth2AuthorizeCodeSessionArgs) GetReq() *identity_srv.OAuth2TokenSession {
	if !p.IsSetReq() {
		return CreateOAuth2AuthorizeCodeSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *CreateOAuth2AuthorizeCodeSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *CreateOAuth2AuthorizeCodeSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type CreateOAuth2AuthorizeCodeSessionResult struct {
	Success *identity_srv.CreateOAuth2AuthorizeCodeSessionResponse
}

var CreateOAuth2AuthorizeCodeSessionResult_Success_DEFAULT *identity_srv.CreateOAuth2AuthorizeCodeSessionResponse

func (p *CreateOAuth2AuthorizeCodeSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *CreateOAuth2AuthorizeCodeSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.CreateOAuth2AuthorizeCodeSessionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *CreateOAuth2AuthorizeCodeSessionResult) GetSuccess() *identity_srv.CreateOAuth2AuthorizeCodeSessionResponse {
	if !p.IsSetSuccess() {
		return CreateOAuth2AuthorizeCodeSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *CreateOAuth2AuthorizeCodeSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.CreateOAuth2AuthorizeCodeSessionResponse)
}

func (p *CreateOAuth2AuthorizeCodeSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CreateOAuth2AuthorizeCodeSessionResult) GetResult() interface{} {
	return p.Success
}
...
func getOAuth2AuthorizeCodeSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.GetOAuth2AuthorizeCodeSessionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).GetOAuth2AuthorizeCodeSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetOAuth2AuthorizeCodeSessionArgs:
		success, err := handler.(identity_srv.IdentityService).GetOAuth2AuthorizeCodeSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetOAuth2AuthorizeCodeSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetOAuth2AuthorizeCodeSessionArgs() interface{} {
	return &GetOAuth2AuthorizeCodeSessionArgs{}
}

func newGetOAuth2AuthorizeCodeSessionResult() interface{} {
	return &GetOAuth2AuthorizeCodeSessionResult{}
}

type GetOAuth2AuthorizeCodeSessionArgs struct {
	Req *identity_srv.GetOAuth2AuthorizeCodeSessionRequest
}

func (p *GetOAuth2AuthorizeCodeSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetOAuth2AuthorizeCodeSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2AuthorizeCodeSessionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetOAuth2AuthorizeCodeSessionArgs_Req_DEFAULT *identity_srv.GetOAuth2AuthorizeCodeSessionRequest

func (p *GetOAuth2AuthorizeCodeSessionArgs) GetReq() *identity_srv.GetOAuth2AuthorizeCodeSessionRequest {
	if !p.IsSetReq() {
		return GetOAuth2AuthorizeCodeSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetOAuth2AuthorizeCodeSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetOAuth2AuthorizeCodeSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetOAuth2AuthorizeCodeSessionResult struct {
	Success *identity_srv.OAuth2TokenSession
}

var GetOAuth2AuthorizeCodeSessionResult_Success_DEFAULT *identity_srv.OAuth2TokenSession

func (p *GetOAuth2AuthorizeCodeSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetOAuth2AuthorizeCodeSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2TokenSession)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *GetOAuth2AuthorizeCodeSessionResult) GetSuccess() *identity_srv.OAuth2TokenSession {
	if !p.IsSetSuccess() {
		return GetOAuth2AuthorizeCodeSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetOAuth2AuthorizeCodeSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.OAuth2TokenSession)
}

func (p *GetOAuth2AuthorizeCodeSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetOAuth2AuthorizeCodeSessionResult) GetResult() interface{} {
	return p.Success
}
...
func invalidateOAuth2AuthorizeCodeSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.InvalidateOAuth2AuthorizeCodeSessionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).InvalidateOAuth2AuthorizeCodeSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *InvalidateOAuth2AuthorizeCodeSessionArgs:
		success, err := handler.(identity_srv.IdentityService).InvalidateOAuth2AuthorizeCodeSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*InvalidateOAuth2AuthorizeCodeSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newInvalidateOAuth2AuthorizeCodeSessionArgs() interface{} {
	return &InvalidateOAuth2AuthorizeCodeSessionArgs{}
}

func newInvalidateOAuth2AuthorizeCodeSessionResult() interface{} {
	return &InvalidateOAuth2AuthorizeCodeSessionResult{}
}

type InvalidateOAuth2AuthorizeCodeSessionArgs struct {
	Req *identity_srv.InvalidateOAuth2AuthorizeCodeSessionRequest
}

func (p *InvalidateOAuth2AuthorizeCodeSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *InvalidateOAuth2AuthorizeCodeSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.InvalidateOAuth2AuthorizeCodeSessionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var InvalidateOAuth2AuthorizeCodeSessionArgs_Req_DEFAULT *identity_srv.InvalidateOAuth2AuthorizeCodeSessionRequest

func (p *InvalidateOAuth2AuthorizeCodeSessionArgs) GetReq() *identity_srv.InvalidateOAuth2AuthorizeCodeSessionRequest {
	if !p.IsSetReq() {
		return InvalidateOAuth2AuthorizeCodeSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *InvalidateOAuth2AuthorizeCodeSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *InvalidateOAuth2AuthorizeCodeSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type InvalidateOAuth2AuthorizeCodeSessionResult struct {
	Success *identity_srv.InvalidateOAuth2AuthorizeCodeSessionResponse
}

var InvalidateOAuth2AuthorizeCodeSessionResult_Success_DEFAULT *identity_srv.InvalidateOAuth2AuthorizeCodeSessionResponse

func (p *InvalidateOAuth2AuthorizeCodeSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *InvalidateOAuth2AuthorizeCodeSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.InvalidateOAuth2AuthorizeCodeSessionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *InvalidateOAuth2AuthorizeCodeSessionResult) GetSuccess() *identity_srv.InvalidateOAuth2AuthorizeCodeSessionResponse {
	if !p.IsSetSuccess() {
		return InvalidateOAuth2AuthorizeCodeSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *InvalidateOAuth2AuthorizeCodeSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.InvalidateOAuth2AuthorizeCodeSessionResponse)
}

func (p *InvalidateOAuth2AuthorizeCodeSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *InvalidateOAuth2AuthorizeCodeSessionResult) GetResult() interface{} {
	return p.Success
}
...
func createOAuth2AccessTokenSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(identity_srv.IdentityService).CreateOAuth2AccessTokenSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *CreateOAuth2AccessTokenSessionArgs:
		success, err := handler.(identity_srv.IdentityService).CreateOAuth2AccessTokenSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*CreateOAuth2AccessTokenSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newCreateOAuth2AccessTokenSessionArgs() interface{} {
	return &CreateOAuth2AccessTokenSessionArgs{}
}

func newCreateOAuth2AccessTokenSessionResult() interface{} {
	return &CreateOAuth2AccessTokenSessionResult{}
}

type CreateOAuth2AccessTokenSessionArgs struct {
	Req *identity_srv.OAuth2TokenSession
}

func (p *CreateOAuth2AccessTokenSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *CreateOAuth2AccessTokenSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2TokenSession)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
var CreateOAuth2AccessTokenSessionArgs_Req_DEFAULT *identity_srv.OAuth2TokenSession

func (p *CreateOAuth2AccessTokenSessionArgs) GetReq() *identity_srv.OAuth2TokenSession {
	if !p.IsSetReq() {
		return CreateOAuth2AccessTokenSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *CreateOAuth2AccessTokenSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *CreateOAuth2AccessTokenSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type CreateOAuth2AccessTokenSessionResult struct {
	Success *identity_srv.CreateOAuth2AccessTokenSessionResponse
}

var CreateOAuth2AccessTokenSessionResult_Success_DEFAULT *identity_srv.CreateOAuth2AccessTokenSessionResponse

func (p *CreateOAuth2AccessTokenSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *CreateOAuth2AccessTokenSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.CreateOAuth2AccessTokenSessionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *CreateOAuth2AccessTokenSessionResult) GetSuccess() *identity_srv.CreateOAuth2AccessTokenSessionResponse {
	if !p.IsSetSuccess() {
		return CreateOAuth2AccessTokenSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *CreateOAuth2AccessTokenSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.CreateOAuth2AccessTokenSessionResponse)
}

func (p *CreateOAuth2AccessTokenSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CreateOAuth2AccessTokenSessionResult) GetResult() interface{} {
	return p.Success
}
...
func getOAuth2AccessTokenSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.GetOAuth2AccessTokenSessionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).GetOAuth2AccessTokenSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetOAuth2AccessTokenSessionArgs:
		success, err := handler.(identity_srv.IdentityService).GetOAuth2AccessTokenSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetOAuth2AccessTokenSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetOAuth2AccessTokenSessionArgs() interface{} {
	return &GetOAuth2AccessTokenSessionArgs{}
}

func newGetOAuth2AccessTokenSessionResult() interface{} {
	return &GetOAuth2AccessTokenSessionResult{}
}

type GetOAuth2AccessTokenSessionArgs struct {
	Req *identity_srv.GetOAuth2AccessTokenSessionRequest
}

func (p *GetOAuth2AccessTokenSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetOAuth2AccessTokenSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2AccessTokenSessionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetOAuth2AccessTokenSessionArgs_Req_DEFAULT *identity_srv.GetOAuth2AccessTokenSessionRequest

func (p *GetOAuth2AccessTokenSessionArgs) GetReq() *identity_srv.GetOAuth2AccessTokenSessionRequest {
	if !p.IsSetReq() {
		return GetOAuth2AccessTokenSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetOAuth2AccessTokenSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetOAuth2AccessTokenSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetOAuth2AccessTokenSessionResult struct {
	Success *identity_srv.OAuth2TokenSession
}

var GetOAuth2AccessTokenSessionResult_Success_DEFAULT *identity_srv.OAuth2TokenSession

func (p *GetOAuth2AccessTokenSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetOAuth2AccessTokenSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2TokenSession)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *GetOAuth2AccessTokenSessionResult) GetSuccess() *identity_srv.OAuth2TokenSession {
	if !p.IsSetSuccess() {
		return GetOAuth2AccessTokenSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetOAuth2AccessTokenSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.OAuth2TokenSession)
}

func (p *GetOAuth2AccessTokenSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetOAuth2AccessTokenSessionResult) GetResult() interface{} {
	return p.Success
}
...
func deleteOAuth2AccessTokenSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.DeleteOAuth2AccessTokenSessionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).DeleteOAuth2AccessTokenSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeleteOAuth2AccessTokenSessionArgs:
		success, err := handler.(identity_srv.IdentityService).DeleteOAuth2AccessTokenSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*DeleteOAuth2AccessTokenSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newDeleteOAuth2AccessTokenSessionArgs() interface{} {
	return &DeleteOAuth2AccessTokenSessionArgs{}
}

func newDeleteOAuth2AccessTokenSessionResult() interface{} {
	return &DeleteOAuth2AccessTokenSessionResult{}
}

type DeleteOAuth2AccessTokenSessionArgs struct {
	Req *identity_srv.DeleteOAuth2AccessTokenSessionRequest
}

func (p *DeleteOAuth2AccessTokenSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *DeleteOAuth2AccessTokenSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.DeleteOAuth2AccessTokenSessionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var DeleteOAuth2AccessTokenSessionArgs_Req_DEFAULT *identity_srv.DeleteOAuth2AccessTokenSessionRequest

func (p *DeleteOAuth2AccessTokenSessionArgs) GetReq() *identity_srv.DeleteOAuth2AccessTokenSessionRequest {
	if !p.IsSetReq() {
		return DeleteOAuth2AccessTokenSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *DeleteOAuth2AccessTokenSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *DeleteOAuth2AccessTokenSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type DeleteOAuth2AccessTokenSessionResult struct {
	Success *identity_srv.DeleteOAuth2AccessTokenSessionResponse
}

var DeleteOAuth2AccessTokenSessionResult_Success_DEFAULT *identity_srv.DeleteOAuth2AccessTokenSessionResponse

func (p *DeleteOAuth2AccessTokenSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *DeleteOAuth2AccessTokenSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.DeleteOAuth2AccessTokenSessionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *DeleteOAuth2AccessTokenSessionResult) GetSuccess() *identity_srv.DeleteOAuth2AccessTokenSessionResponse {
	if !p.IsSetSuccess() {
		return DeleteOAuth2AccessTokenSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *DeleteOAuth2AccessTokenSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.DeleteOAuth2AccessTokenSessionResponse)
}

func (p *DeleteOAuth2AccessTokenSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *DeleteOAuth2AccessTokenSessionResult) GetResult() interface{} {
	return p.Success
}
...
func revokeOAuth2AccessTokenHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.RevokeOAuth2AccessTokenRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).RevokeOAuth2AccessToken(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *RevokeOAuth2AccessTokenArgs:
		success, err := handler.(identity_srv.IdentityService).RevokeOAuth2AccessToken(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*RevokeOAuth2AccessTokenResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newRevokeOAuth2AccessTokenArgs() interface{} {
	return &RevokeOAuth2AccessTokenArgs{}
}

func newRevokeOAuth2AccessTokenResult() interface{} {
	return &RevokeOAuth2AccessTokenResult{}
}

type RevokeOAuth2AccessTokenArgs struct {
	Req *identity_srv.RevokeOAuth2AccessTokenRequest
}

func (p *RevokeOAuth2AccessTokenArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *RevokeOAuth2AccessTokenArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.RevokeOAuth2AccessTokenRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var RevokeOAuth2AccessTokenArgs_Req_DEFAULT *identity_srv.RevokeOAuth2AccessTokenRequest

func (p *RevokeOAuth2AccessTokenArgs) GetReq() *identity_srv.RevokeOAuth2AccessTokenRequest {
	if !p.IsSetReq() {
		return RevokeOAuth2AccessTokenArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *RevokeOAuth2AccessTokenArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *RevokeOAuth2AccessTokenArgs) GetFirstArgument() interface{} {
	return p.Req
}

type RevokeOAuth2AccessTokenResult struct {
	Success *identity_srv.RevokeOAuth2AccessTokenResponse
}

var RevokeOAuth2AccessTokenResult_Success_DEFAULT *identity_srv.RevokeOAuth2AccessTokenResponse

func (p *RevokeOAuth2AccessTokenResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *RevokeOAuth2AccessTokenResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.RevokeOAuth2AccessTokenResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *RevokeOAuth2AccessTokenResult) GetSuccess() *identity_srv.RevokeOAuth2AccessTokenResponse {
	if !p.IsSetSuccess() {
		return RevokeOAuth2AccessTokenResult_Success_DEFAULT
	}
	return p.Success
}

func (p *RevokeOAuth2AccessTokenResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.RevokeOAuth2AccessTokenResponse)
}

func (p *RevokeOAuth2AccessTokenResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RevokeOAuth2AccessTokenResult) GetResult() interface{} {
	return p.Success
}
...
func createOAuth2RefreshTokenSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(identity_srv.IdentityService).CreateOAuth2RefreshTokenSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *CreateOAuth2RefreshTokenSessionArgs:
		success, err := handler.(identity_srv.IdentityService).CreateOAuth2RefreshTokenSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*CreateOAuth2RefreshTokenSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newCreateOAuth2RefreshTokenSessionArgs() interface{} {
	return &CreateOAuth2RefreshTokenSessionArgs{}
}

func newCreateOAuth2RefreshTokenSessionResult() interface{} {
	return &CreateOAuth2RefreshTokenSessionResult{}
}

type CreateOAuth2RefreshTokenSessionArgs struct {
	Req *identity_srv.OAuth2TokenSession
}

func (p *CreateOAuth2RefreshTokenSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *CreateOAuth2RefreshTokenSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2TokenSession)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
var CreateOAuth2RefreshTokenSessionArgs_Req_DEFAULT *identity_srv.OAuth2TokenSession

func (p *CreateOAuth2RefreshTokenSessionArgs) GetReq() *identity_srv.OAuth2TokenSession {
	if !p.IsSetReq() {
		return CreateOAuth2RefreshTokenSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *CreateOAuth2RefreshTokenSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *CreateOAuth2RefreshTokenSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type CreateOAuth2RefreshTokenSessionResult struct {
	Success *identity_srv.CreateOAuth2RefreshTokenSessionResponse
}

var CreateOAuth2RefreshTokenSessionResult_Success_DEFAULT *identity_srv.CreateOAuth2RefreshTokenSessionResponse

func (p *CreateOAuth2RefreshTokenSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *CreateOAuth2RefreshTokenSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.CreateOAuth2RefreshTokenSessionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *CreateOAuth2RefreshTokenSessionResult) GetSuccess() *identity_srv.CreateOAuth2RefreshTokenSessionResponse {
	if !p.IsSetSuccess() {
		return CreateOAuth2RefreshTokenSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *CreateOAuth2RefreshTokenSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.CreateOAuth2RefreshTokenSessionResponse)
}

func (p *CreateOAuth2RefreshTokenSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CreateOAuth2RefreshTokenSessionResult) GetResult() interface{} {
	return p.Success
}
...
func getOAuth2RefreshTokenSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.GetOAuth2RefreshTokenSessionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).GetOAuth2RefreshTokenSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetOAuth2RefreshTokenSessionArgs:
		success, err := handler.(identity_srv.IdentityService).GetOAuth2RefreshTokenSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetOAuth2RefreshTokenSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetOAuth2RefreshTokenSessionArgs() interface{} {
	return &GetOAuth2RefreshTokenSessionArgs{}
}

func newGetOAuth2RefreshTokenSessionResult() interface{} {
	return &GetOAuth2RefreshTokenSessionResult{}
}

type GetOAuth2RefreshTokenSessionArgs struct {
	Req *identity_srv.GetOAuth2RefreshTokenSessionRequest
}

func (p *GetOAuth2RefreshTokenSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetOAuth2RefreshTokenSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2RefreshTokenSessionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetOAuth2RefreshTokenSessionArgs_Req_DEFAULT *identity_srv.GetOAuth2RefreshTokenSessionRequest

func (p *GetOAuth2RefreshTokenSessionArgs) GetReq() *identity_srv.GetOAuth2RefreshTokenSessionRequest {
	if !p.IsSetReq() {
		return GetOAuth2RefreshTokenSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetOAuth2RefreshTokenSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetOAuth2RefreshTokenSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetOAuth2RefreshTokenSessionResult struct {
	Success *identity_srv.OAuth2TokenSession
}

var GetOAuth2RefreshTokenSessionResult_Success_DEFAULT *identity_srv.OAuth2TokenSession

func (p *GetOAuth2RefreshTokenSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetOAuth2RefreshTokenSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2TokenSession)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *GetOAuth2RefreshTokenSessionResult) GetSuccess() *identity_srv.OAuth2TokenSession {
	if !p.IsSetSuccess() {
		return GetOAuth2RefreshTokenSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetOAuth2RefreshTokenSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.OAuth2TokenSession)
}

func (p *GetOAuth2RefreshTokenSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetOAuth2RefreshTokenSessionResult) GetResult() interface{} {
	return p.Success
}
...
func deleteOAuth2RefreshTokenSessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.DeleteOAuth2RefreshTokenSessionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).DeleteOAuth2RefreshTokenSession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeleteOAuth2RefreshTokenSessionArgs:
		success, err := handler.(identity_srv.IdentityService).DeleteOAuth2RefreshTokenSession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*DeleteOAuth2RefreshTokenSessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newDeleteOAuth2RefreshTokenSessionArgs() interface{} {
	return &DeleteOAuth2RefreshTokenSessionArgs{}
}

func newDeleteOAuth2RefreshTokenSessionResult() interface{} {
	return &DeleteOAuth2RefreshTokenSessionResult{}
}

type DeleteOAuth2RefreshTokenSessionArgs struct {
	Req *identity_srv.DeleteOAuth2RefreshTokenSessionRequest
}

func (p *DeleteOAuth2RefreshTokenSessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *DeleteOAuth2RefreshTokenSessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.DeleteOAuth2RefreshTokenSessionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var DeleteOAuth2RefreshTokenSessionArgs_Req_DEFAULT *identity_srv.DeleteOAuth2RefreshTokenSessionRequest

func (p *DeleteOAuth2RefreshTokenSessionArgs) GetReq() *identity_srv.DeleteOAuth2RefreshTokenSessionRequest {
	if !p.IsSetReq() {
		return DeleteOAuth2RefreshTokenSessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *DeleteOAuth2RefreshTokenSessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *DeleteOAuth2RefreshTokenSessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type DeleteOAuth2RefreshTokenSessionResult struct {
	Success *identity_srv.DeleteOAuth2RefreshTokenSessionResponse
}

var DeleteOAuth2RefreshTokenSessionResult_Success_DEFAULT *identity_srv.DeleteOAuth2RefreshTokenSessionResponse

func (p *DeleteOAuth2RefreshTokenSessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *DeleteOAuth2RefreshTokenSessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.DeleteOAuth2RefreshTokenSessionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *DeleteOAuth2RefreshTokenSessionResult) GetSuccess() *identity_srv.DeleteOAuth2RefreshTokenSessionResponse {
	if !p.IsSetSuccess() {
		return DeleteOAuth2RefreshTokenSessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *DeleteOAuth2RefreshTokenSessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.DeleteOAuth2RefreshTokenSessionResponse)
}

func (p *DeleteOAuth2RefreshTokenSessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *DeleteOAuth2RefreshTokenSessionResult) GetResult() interface{} {
	return p.Success
}
...
func revokeOAuth2RefreshTokenHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.RevokeOAuth2RefreshTokenRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).RevokeOAuth2RefreshToken(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *RevokeOAuth2RefreshTokenArgs:
		success, err := handler.(identity_srv.IdentityService).RevokeOAuth2RefreshToken(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*RevokeOAuth2RefreshTokenResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newRevokeOAuth2RefreshTokenArgs() interface{} {
	return &RevokeOAuth2RefreshTokenArgs{}
}

func newRevokeOAuth2RefreshTokenResult() interface{} {
	return &RevokeOAuth2RefreshTokenResult{}
}

type RevokeOAuth2RefreshTokenArgs struct {
	Req *identity_srv.RevokeOAuth2RefreshTokenRequest
}

func (p *RevokeOAuth2RefreshTokenArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *RevokeOAuth2RefreshTokenArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.RevokeOAuth2RefreshTokenRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var RevokeOAuth2RefreshTokenArgs_Req_DEFAULT *identity_srv.RevokeOAuth2RefreshTokenRequest

func (p *RevokeOAuth2RefreshTokenArgs) GetReq() *identity_srv.RevokeOAuth2RefreshTokenRequest {
	if !p.IsSetReq() {
		return RevokeOAuth2RefreshTokenArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *RevokeOAuth2RefreshTokenArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *RevokeOAuth2RefreshTokenArgs) GetFirstArgument() interface{} {
	return p.Req
}

type RevokeOAuth2RefreshTokenResult struct {
	Success *identity_srv.RevokeOAuth2RefreshTokenResponse
}

var RevokeOAuth2RefreshTokenResult_Success_DEFAULT *identity_srv.RevokeOAuth2RefreshTokenResponse

func (p *RevokeOAuth2RefreshTokenResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *RevokeOAuth2RefreshTokenResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.RevokeOAuth2RefreshTokenResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *RevokeOAuth2RefreshTokenResult) GetSuccess() *identity_srv.RevokeOAuth2RefreshTokenResponse {
	if !p.IsSetSuccess() {
		return RevokeOAuth2RefreshTokenResult_Success_DEFAULT
	}
	return p.Success
}

func (p *RevokeOAuth2RefreshTokenResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.RevokeOAuth2RefreshTokenResponse)
}

func (p *RevokeOAuth2RefreshTokenResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RevokeOAuth2RefreshTokenResult) GetResult() interface{} {
	return p.Success
}
...
func createOAuth2PKCESessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(identity_srv.IdentityService).CreateOAuth2PKCESession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *CreateOAuth2PKCESessionArgs:
		success, err := handler.(identity_srv.IdentityService).CreateOAuth2PKCESession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*CreateOAuth2PKCESessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newCreateOAuth2PKCESessionArgs() interface{} {
	return &CreateOAuth2PKCESessionArgs{}
}

func newCreateOAuth2PKCESessionResult() interface{} {
	return &CreateOAuth2PKCESessionResult{}
}

type CreateOAuth2PKCESessionArgs struct {
	Req *identity_srv.OAuth2TokenSession
}

func (p *CreateOAuth2PKCESessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *CreateOAuth2PKCESessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2TokenSession)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
var CreateOAuth2PKCESessionArgs_Req_DEFAULT *identity_srv.OAuth2TokenSession

func (p *CreateOAuth2PKCESessionArgs) GetReq() *identity_srv.OAuth2TokenSession {
	if !p.IsSetReq() {
		return CreateOAuth2PKCESessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *CreateOAuth2PKCESessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *CreateOAuth2PKCESessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type CreateOAuth2PKCESessionResult struct {
	Success *identity_srv.CreateOAuth2PKCESessionResponse
}

var CreateOAuth2PKCESessionResult_Success_DEFAULT *identity_srv.CreateOAuth2PKCESessionResponse

func (p *CreateOAuth2PKCESessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *CreateOAuth2PKCESessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.CreateOAuth2PKCESessionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *CreateOAuth2PKCESessionResult) GetSuccess() *identity_srv.CreateOAuth2PKCESessionResponse {
	if !p.IsSetSuccess() {
		return CreateOAuth2PKCESessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *CreateOAuth2PKCESessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.CreateOAuth2PKCESessionResponse)
}

func (p *CreateOAuth2PKCESessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CreateOAuth2PKCESessionResult) GetResult() interface{} {
	return p.Success
}
...
func getOAuth2PKCESessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.GetOAuth2PKCESessionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).GetOAuth2PKCESession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetOAuth2PKCESessionArgs:
		success, err := handler.(identity_srv.IdentityService).GetOAuth2PKCESession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetOAuth2PKCESessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetOAuth2PKCESessionArgs() interface{} {
	return &GetOAuth2PKCESessionArgs{}
}

func newGetOAuth2PKCESessionResult() interface{} {
	return &GetOAuth2PKCESessionResult{}
}

type GetOAuth2PKCESessionArgs struct {
	Req *identity_srv.GetOAuth2PKCESessionRequest
}

func (p *GetOAuth2PKCESessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetOAuth2PKCESessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.GetOAuth2PKCESessionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetOAuth2PKCESessionArgs_Req_DEFAULT *identity_srv.GetOAuth2PKCESessionRequest

func (p *GetOAuth2PKCESessionArgs) GetReq() *identity_srv.GetOAuth2PKCESessionRequest {
	if !p.IsSetReq() {
		return GetOAuth2PKCESessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetOAuth2PKCESessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetOAuth2PKCESessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetOAuth2PKCESessionResult struct {
	Success *identity_srv.OAuth2TokenSession
}

var GetOAuth2PKCESessionResult_Success_DEFAULT *identity_srv.OAuth2TokenSession

func (p *GetOAuth2PKCESessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetOAuth2PKCESessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.OAuth2TokenSession)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *GetOAuth2PKCESessionResult) GetSuccess() *identity_srv.OAuth2TokenSession {
	if !p.IsSetSuccess() {
		return GetOAuth2PKCESessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetOAuth2PKCESessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.OAuth2TokenSession)
}

func (p *GetOAuth2PKCESessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetOAuth2PKCESessionResult) GetResult() interface{} {
	return p.Success
}
...
func deleteOAuth2PKCESessionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(identity_srv.DeleteOAuth2PKCESessionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(identity_srv.IdentityService).DeleteOAuth2PKCESession(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeleteOAuth2PKCESessionArgs:
		success, err := handler.(identity_srv.IdentityService).DeleteOAuth2PKCESession(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*DeleteOAuth2PKCESessionResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newDeleteOAuth2PKCESessionArgs() interface{} {
	return &DeleteOAuth2PKCESessionArgs{}
}

func newDeleteOAuth2PKCESessionResult() interface{} {
	return &DeleteOAuth2PKCESessionResult{}
}

type DeleteOAuth2PKCESessionArgs struct {
	Req *identity_srv.DeleteOAuth2PKCESessionRequest
}

func (p *DeleteOAuth2PKCESessionArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *DeleteOAuth2PKCESessionArgs) Unmarshal(in []byte) error {
	msg := new(identity_srv.DeleteOAuth2PKCESessionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var DeleteOAuth2PKCESessionArgs_Req_DEFAULT *identity_srv.DeleteOAuth2PKCESessionRequest

func (p *DeleteOAuth2PKCESessionArgs) GetReq() *identity_srv.DeleteOAuth2PKCESessionRequest {
	if !p.IsSetReq() {
		return DeleteOAuth2PKCESessionArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *DeleteOAuth2PKCESessionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *DeleteOAuth2PKCESessionArgs) GetFirstArgument() interface{} {
	return p.Req
}

type DeleteOAuth2PKCESessionResult struct {
	Success *identity_srv.DeleteOAuth2PKCESessionResponse
}

var DeleteOAuth2PKCESessionResult_Success_DEFAULT *identity_srv.DeleteOAuth2PKCESessionResponse

func (p *DeleteOAuth2PKCESessionResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *DeleteOAuth2PKCESessionResult) Unmarshal(in []byte) error {
	msg := new(identity_srv.DeleteOAuth2PKCESessionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *DeleteOAuth2PKCESessionResult) GetSuccess() *identity_srv.DeleteOAuth2PKCESessionResponse {
	if !p.IsSetSuccess() {
		return DeleteOAuth2PKCESessionResult_Success_DEFAULT
	}
	return p.Success
}

func (p *DeleteOAuth2PKCESessionResult) SetSuccess(x interface{}) {
	p.Success = x.(*identity_srv.DeleteOAuth2PKCESessionResponse)
}

func (p *DeleteOAuth2PKCESessionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *DeleteOAuth2PKCESessionResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) CreateOAuth2Client(ctx context.Context, Req *identity_srv.CreateOAuth2ClientRequest) (r *identity_srv.CreateOAuth2ClientResponse, err error) {
	var _args CreateOAuth2ClientArgs
	_args.Req = Req
	var _result CreateOAuth2ClientResult
...
func (p *kClient) GetOAuth2Client(ctx context.Context, Req *identity_srv.GetOAuth2ClientRequest) (r *identity_srv.OAuth2Client, err error) {
	var _args GetOAuth2ClientArgs
	_args.Req = Req
	var _result GetOAuth2ClientResult
...
func (p *kClient) UpdateOAuth2Client(ctx context.Context, Req *identity_srv.UpdateOAuth2ClientRequest) (r *identity_srv.OAuth2Client, err error) {
	var _args UpdateOAuth2ClientArgs
	_args.Req = Req
	var _result UpdateOAuth2ClientResult
...
func (p *kClient) DeleteOAuth2Client(ctx context.Context, Req *identity_srv.DeleteOAuth2ClientRequest) (r *identity_srv.DeleteOAuth2ClientResponse, err error) {
	var _args DeleteOAuth2ClientArgs
	_args.Req = Req
	var _result DeleteOAuth2ClientResult
...
func (p *kClient) ListOAuth2Clients(ctx context.Context, Req *identity_srv.ListOAuth2ClientsRequest) (r *identity_srv.ListOAuth2ClientsResponse, err error) {
	var _args ListOAuth2ClientsArgs
	_args.Req = Req
	var _result ListOAuth2ClientsResult
...
func (p *kClient) RotateOAuth2ClientSecret(ctx context.Context, Req *identity_srv.RotateOAuth2ClientSecretRequest) (r *identity_srv.RotateOAuth2ClientSecretResponse, err error) {
	var _args RotateOAuth2ClientSecretArgs
	_args.Req = Req
	var _result RotateOAuth2ClientSecretResult
...
func (p *kClient) GetOAuth2ClientForAuth(ctx context.Context, Req *identity_srv.GetOAuth2ClientForAuthRequest) (r *identity_srv.GetOAuth2ClientForAuthResponse, err error) {
	var _args GetOAuth2ClientForAuthArgs
	_args.Req = Req
	var _result GetOAuth2ClientForAuthResult
...
func (p *kClient) ListOAuth2Scopes(ctx context.Context, Req *identity_srv.ListOAuth2ScopesRequest) (r *identity_srv.ListOAuth2ScopesResponse, err error) {
	var _args ListOAuth2ScopesArgs
	_args.Req = Req
	var _result ListOAuth2ScopesResult
...
func (p *kClient) SaveOAuth2Consent(ctx context.Context, Req *identity_srv.SaveOAuth2ConsentRequest) (r *identity_srv.SaveOAuth2ConsentResponse, err error) {
	var _args SaveOAuth2ConsentArgs
	_args.Req = Req
	var _result SaveOAuth2ConsentResult
...
func (p *kClient) GetOAuth2Consent(ctx context.Context, Req *identity_srv.GetOAuth2ConsentRequest) (r *identity_srv.GetOAuth2ConsentResponse, err error) {
	var _args GetOAuth2ConsentArgs
	_args.Req = Req
	var _result GetOAuth2ConsentResult
...
func (p *kClient) ListOAuth2Consents(ctx context.Context, Req *identity_srv.ListOAuth2ConsentsRequest) (r *identity_srv.ListOAuth2ConsentsResponse, err error) {
	var _args ListOAuth2ConsentsArgs
	_args.Req = Req
	var _result ListOAuth2ConsentsResult
...
func (p *kClient) RevokeOAuth2Consent(ctx context.Context, Req *identity_srv.RevokeOAuth2ConsentRequest) (r *identity_srv.RevokeOAuth2ConsentResponse, err error) {
	var _args RevokeOAuth2ConsentArgs
	_args.Req = Req
	var _result RevokeOAuth2ConsentResult
...
func (p *kClient) CreateOAuth2AuthorizeCodeSession(ctx context.Context, Req *identity_srv.OAuth2TokenSession) (r *identity_srv.CreateOAuth2AuthorizeCodeSessionResponse, err error) {
	var _args CreateOAuth2AuthorizeCodeSessionArgs
	_args.Req = Req
	var _result CreateOAuth2AuthorizeCodeSessionResult
...
func (p *kClient) GetOAuth2AuthorizeCodeSession(ctx context.Context, Req *identity_srv.GetOAuth2AuthorizeCodeSessionRequest) (r *identity_srv.OAuth2TokenSession, err error) {
	var _args GetOAuth2AuthorizeCodeSessionArgs
	_args.Req = Req
	var _result GetOAuth2AuthorizeCodeSessionResult
...
func (p *kClient) InvalidateOAuth2AuthorizeCodeSession(ctx context.Context, Req *identity_srv.InvalidateOAuth2AuthorizeCodeSessionRequest) (r *identity_srv.InvalidateOAuth2AuthorizeCodeSessionResponse, err error) {
	var _args InvalidateOAuth2AuthorizeCodeSessionArgs
	_args.Req = Req
	var _result InvalidateOAuth2AuthorizeCodeSessionResult
...
func (p *kClient) CreateOAuth2AccessTokenSession(ctx context.Context, Req *identity_srv.OAuth2TokenSession) (r *identity_srv.CreateOAuth2AccessTokenSessionResponse, err error) {
	var _args CreateOAuth2AccessTokenSessionArgs
	_args.Req = Req
	var _result CreateOAuth2AccessTokenSessionResult
...
func (p *kClient) GetOAuth2AccessTokenSession(ctx context.Context, Req *identity_srv.GetOAuth2AccessTokenSessionRequest) (r *identity_srv.OAuth2TokenSession, err error) {
	var _args GetOAuth2AccessTokenSessionArgs
	_args.Req = Req
	var _result GetOAuth2AccessTokenSessionResult
...
func (p *kClient) DeleteOAuth2AccessTokenSession(ctx context.Context, Req *identity_srv.DeleteOAuth2AccessTokenSessionRequest) (r *identity_srv.DeleteOAuth2AccessTokenSessionResponse, err error) {
	var _args DeleteOAuth2AccessTokenSessionArgs
	_args.Req = Req
	var _result DeleteOAuth2AccessTokenSessionResult
...
func (p *kClient) RevokeOAuth2AccessToken(ctx context.Context, Req *identity_srv.RevokeOAuth2AccessTokenRequest) (r *identity_srv.RevokeOAuth2AccessTokenResponse, err error) {
	var _args RevokeOAuth2AccessTokenArgs
	_args.Req = Req
	var _result RevokeOAuth2AccessTokenResult
...
func (p *kClient) CreateOAuth2RefreshTokenSession(ctx context.Context, Req *identity_srv.OAuth2TokenSession) (r *identity_srv.CreateOAuth2RefreshTokenSessionResponse, err error) {
	var _args CreateOAuth2RefreshTokenSessionArgs
	_args.Req = Req
	var _result CreateOAuth2RefreshTokenSessionResult
...
func (p *kClient) GetOAuth2RefreshTokenSession(ctx context.Context, Req *identity_srv.GetOAuth2RefreshTokenSessionRequest) (r *identity_srv.OAuth2TokenSession, err error) {
	var _args GetOAuth2RefreshTokenSessionArgs
	_args.Req = Req
	var _result GetOAuth2RefreshTokenSessionResult
...
func (p *kClient) DeleteOAuth2RefreshTokenSession(ctx context.Context, Req *identity_srv.DeleteOAuth2RefreshTokenSessionRequest) (r *identity_srv.DeleteOAuth2RefreshTokenSessionResponse, err error) {
	var _args DeleteOAuth2RefreshTokenSessionArgs
	_args.Req = Req
	var _result DeleteOAuth2RefreshTokenSessionResult
...
func (p *kClient) RevokeOAuth2RefreshToken(ctx context.Context, Req *identity_srv.RevokeOAuth2RefreshTokenRequest) (r *identity_srv.RevokeOAuth2RefreshTokenResponse, err error) {
	var _args RevokeOAuth2RefreshTokenArgs
	_args.Req = Req
	var _result RevokeOAuth2RefreshTokenResult
...
func (p *kClient) CreateOAuth2PKCESession(ctx context.Context, Req *identity_srv.OAuth2TokenSession) (r *identity_srv.CreateOAuth2PKCESessionResponse, err error) {
	var _args CreateOAuth2PKCESessionArgs
	_args.Req = Req
	var _result CreateOAuth2PKCESessionResult
...
func (p *kClient) GetOAuth2PKCESession(ctx context.Context, Req *identity_srv.GetOAuth2PKCESessionRequest) (r *identity_srv.OAuth2TokenSession, err error) {
	var _args GetOAuth2PKCESessionArgs
	_args.Req = Req
	var _result GetOAuth2PKCESessionResult
...
func (p *kClient) DeleteOAuth2PKCESession(ctx context.Context, Req *identity_srv.DeleteOAuth2PKCESessionRequest) (r *identity_srv.DeleteOAuth2PKCESessionResponse, err error) {
	var _args DeleteOAuth2PKCESessionArgs
	_args.Req = Req
	var _result DeleteOAuth2PKCESessionResult
