module github.com/masonsxu/cloudwego-microservice-demo/iamclient
...
require (
	...
	github.com/masonsxu/cloudwego-microservice-demo/rpc/policy-srv v0.0.0-00010101000000-000000000000
)
